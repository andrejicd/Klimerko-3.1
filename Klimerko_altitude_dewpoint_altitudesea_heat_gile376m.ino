...
const char*    firmwareVersionPortal   = "<p>Firmware Version: 3.1 by andrejicd</p>";
char           klimerkoID[32];
...
// Calculate HI (heatindex in °C) --> HI starts working above 26,7 °C
  if (temperature > 26.7) {
 // double c1 = -8.784, c2 = 1.611, c3 = 2.338, c4 = -0.146, c5= -1.230e-2, c6=-1.642e-2, c7=2.211e-3, c8=7.254e-4, c9=-3.582e-6  ;
